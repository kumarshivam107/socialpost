                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{url('register')}}">@csrf
                                ...
                                <div class="form-group">
                                    <input type="tel" class="form-control form-control-user" id="mobile" maxlength="10" placeholder="Mobile Number" name="mobile" required>
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
