...
<style>
    ...
    (min-device-width: 768px) and (max-device-width: 1024px)  {
        ...
        */
        ...
        td:nth-of-type(4):before { content: "College Name"; }
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pending Admission</h1>
    </div>
    <div class="row">
    ...
    <table  id="bona_data" width="100%" cellspacing="0">
        <thead>
...
<script>
    $(document).ready(function(){
        ...
        function fill_datatable(agent_name='',college_name=''){
            var dataTable = $('#bona_data').DataTable({
                processing:true,
                serverSide:true,
                ajax:{
                    url:"{{url('/admin/pending-admission')}}",
