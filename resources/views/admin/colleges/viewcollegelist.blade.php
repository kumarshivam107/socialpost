...
<h3>View All College</h3>
        ...
        @endif
    <table class="college_table" width="100%" cellspacing="0">
        <thead>
            <tr>
                <th>S.No</th>
                <th>College Name</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{$sno++}}</td>
                <td>{{$college_list->college_name}}</td>
                <td>{{$college_list->college_city}}</td>
                <td>{{$college_list->college_state}}</td>
                <td><a class="btn btn-success btn-sm" href="{{url('/admin/delete-college/'.$college_list->college_id.'')}}">Delete College</a></td>
            </tr>
            @endforeach                        
        </tbody>
    </table>
